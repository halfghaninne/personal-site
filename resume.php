...
<?php include('_header.php') ?>
  ...
  <!-- <div class="page-content">
    <div class="block-fill-height">
      <div class="container">
        <embed src="AlexandraMillatmal.Dec2017.pdf" class="block-fill-height">
      </div>
    </div>
  </div> -->
      ...
      <!-- <div class="block-lg-middle"> -->
        <div class="row resume-row">
          <div class="caption resume-section">
            ...
            <div class="resume-section-role">
              ...
              <p>
                Set learning objectives and curriculum structure for Girls Who Code's Campus Web Development program, a national tuition-based course launching in summer 2018. Determined best tools and practices for course curriculum and wrote hands-on tutorials for students on concepts such as HTML/CSS, Flexbox, JavaScript events, APIs, debugging, and project planning.
              </p>
            </div>
        ...
        <div class="row resume-row">
          <div class="caption resume-section">
            ...
            <div class="resume-section-role">
              ...
              <p>
                Provide career guidance and coaching, support, and community to a 2018 Code2040 Fellow during their summer engineering placement. 
              </p>
            </div>
        ...
        <div class="row resume-row">
          <div class="caption resume-section">
            ...
            <div class="resume-section-role">
              <h3 class="resume-section-role-title">
                <span>Jackie Blizzard</span>
                <ul class="contact">
                  <!-- <li><a href="" target="_blank"><span class="icon icon-paper-plane"></span></a></li> -->
